...
export default function Section4() {
    return (
        <section>
            <div>
                <p class="phrase">The world's</p>
                <p class="phrase">biggest healthcare platform</p>
                <p>We work from 6 offices all over the world, bringing Docplanner Group to life in almost 20 countries.</p>

                <img src="https://slack-redir.net/link?url=https%3A%2F%2Fres-5.cloudinary.com%2Fcrunchbase-production%2Fimage%2Fupload%2Fc_lpad%2Cf_auto%2Cq_auto%3Aeco%2Fjcmy9zzlqh682l0my9p3" />
            ...
            <div>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <h4>30 million unique patients</h4>
                        <p>
                ...
                <div>
                    <div>
                        ...
                        <h5>1.5 million appointments</h5>
                        <p>
                            booked last month
                            </p>
                    </div>
                    <div>
                        ...
                        <h6 class="h3">2 million active doctors</h6>
                        <p>
                            trust
                            in our solutions
                                </p>
